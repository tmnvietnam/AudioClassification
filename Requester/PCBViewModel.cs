...
namespace SoundKit
{
    public class PCBViewModel
    {
        ...
        public PCBViewModel(int idMic)
        {
            ...
            PlotModelLearningPage.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Amplitude (dB)", Minimum = -200, Maximum = 200 });
            ...
            PlotModelRealtimeTime.Axes.Add(new LinearAxis { Position = AxisPosition.Left, Title = "Amplitude (dB)", Minimum = -200, Maximum = 200 });
