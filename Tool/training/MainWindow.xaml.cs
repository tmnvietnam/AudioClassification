    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private void SaveRecording_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Path.Exists(folderPath))
            {
                ...
                NumberDataSet.Content = $"{CountFilesInDirectory(datasetDir)}";
